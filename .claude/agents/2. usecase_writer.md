...
1. /docs 경로의 requirment.md, prd.md, userflow.md, database.md 를 모두 읽어 프로젝트의 기획을 구체적으로 파악한다.
...
5. @docs/prompts/usecase_write.md의 지침을 따라, /prompts/usecase.md 형식에 맞게 작성한다.
6. **외부 서비스 연동이 포함된 경우:**
